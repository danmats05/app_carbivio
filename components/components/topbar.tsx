    ...
    <div className="flex items-center justify-between p-6 border-b bg-[#151514] border-white/10">
      ...
      <div className="flex items-center gap-4">
        <DropdownMenu>
          ...
          >
            <DropdownMenuLabel className="text-white font-heuvel">
              Notifications
            </DropdownMenuLabel>
            <DropdownMenuSeparator className="bg-white/10" />
            <DropdownMenuItem className="text-white hover:bg-white/10">
              <div className="flex flex-col gap-1">
                <p className="text-sm font-medium font-heuvel">
          ...
          <DropdownMenuTrigger asChild>
            ...
            >
              <Avatar className="h-8 w-8">
                ...
                />
                <AvatarFallback className="bg-[#eca226] text-black font-heuvel">
                  AC
                </AvatarFallback>
              </Avatar>
            </Button>
